...
public class math extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mod1.setOnClickListener(v -> {
            String value="https://drive.google.com/file/d/1af4G4h0EQEvbUYZpSnWMysPXaPFE1-5f/view?usp=sharing";
        ...
        mod2.setOnClickListener(v -> {
            String value="https://drive.google.com/file/d/168ZFUh1DNVNf02s62uc6lXmwKpXJRpMe/view?usp=sharing";
            Intent intent=new Intent(Intent.ACTION_VIEW, Uri.parse(value));
